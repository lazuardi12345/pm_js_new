...
@Entity({ name: 'collateral_umkm' })
export class CollateralUMKM_ORM_Entity {
  @PrimaryGeneratedColumn()
  id: number;

  // Relasi ke tabel pengajuan (Loan Application)
  ...
  @Column({ name: 'foto_pembukuan', type: 'varchar', length: 255, nullable: true })
