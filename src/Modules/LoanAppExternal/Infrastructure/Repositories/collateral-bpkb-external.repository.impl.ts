  ...
  implements ICollateralByBPKBRepository
{
  ...
  private toORM(domain: CollateralByBPKB): CollateralByBPKB_ORM_Entity {
    ...
    orm.pengajuanLuar = { id: domain.pengajuan.id } as any;
  ...
  private toOrmPartial(
    ...
    if (partial.tahun_perakitan)
      ormData.tahun_perakitan = partial.tahun_perakitan;
    if (partial.warna_kendaraan)
      ormData.warna_kendaraan = partial.warna_kendaraan;
