...
export class LoanApplicationExternalController {
  constructor(private readonly loanApplicationService: LoanApplicationExternalService) {}
  ...
  @Put(':id')
  async update(@Param('id') id: number, @Body() dto: UpdateLoanApplicationExternalDto) {
