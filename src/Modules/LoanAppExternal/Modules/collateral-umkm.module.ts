...
import { CollateralUMKM_ORM_Entity } from '../Infrastructure/Entities/collateral-umkm.orm.entity';
...
@Module({
  imports: [TypeOrmModule.forFeature([CollateralUMKM_ORM_Entity])],
  providers: [
...
export class CollateralUMKM_External_Module {}
