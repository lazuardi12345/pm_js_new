...
import { COLLATERAL_KEDINASAN_MOU_EXTERNAL_REPOSITORY } from '../Domain/Repositories/collateral-kedinasan-mou-external.repository';
...
@Module({
  ...
  providers: [
    ...
    {
      provide: COLLATERAL_KEDINASAN_MOU_EXTERNAL_REPOSITORY,
