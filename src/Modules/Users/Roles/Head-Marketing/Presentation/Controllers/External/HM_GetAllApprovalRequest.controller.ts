...
@Controller('hm/ext/loan-apps/request')
export class HM_GetAllApprovalRequestExternalController {
  constructor(
    private readonly getAllApprovalRequestUseCase: HM_GetAllApprovalRequestExternalUseCase,
  ) {}
