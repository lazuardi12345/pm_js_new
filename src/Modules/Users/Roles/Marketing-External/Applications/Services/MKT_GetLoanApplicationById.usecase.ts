          ...
          collateralData = {
            collateral_bpkb: {
              ...
              foto_kendaraan_depan:
                loanData.pengajuan_bpkb?.foto_kendaraan_depan,
          ...
          collateralData = {
            collateral_kedinasan_mou: {
              ...
              foto_surat_pernyataan_peminjam:
                loanData.pengajuan_kedinasan_mou
                  ?.foto_surat_pernyataan_peminjam,
        ...
        case 'KEDINASAN_NON_MOU':
          collateralData = {
            collateral_kedinasan_non_mou: {
              ...
              surat_persetujuan_pimpinan:
                loanData.pengajuan_kedinasan_non_mou
                  ?.surat_persetujuan_pimpinan,
              surat_keterangan_gaji:
      ...
      return {
        ...
        data: {
          client_and_loan_detail: {
            ...
            loan_external: {
              jenis_pembiayaan: loanData.jenis_pembiayaan, // enum
              nominal_pinjaman: loanData.nominal_pinjaman,
              tenor: loanData.tenor,
              berkas_jaminan: loanData.berkas_jaminan,
              status_pinjaman: loanData.status_pinjaman, // optional enum
              pinjaman_ke: loanData.pinjaman_ke, // optional number
              pinjaman_terakhir: loanData.pinjaman_terakhir, // optional number
              sisa_pinjaman: loanData.sisa_pinjaman, // optional number
              realisasi_pinjaman: loanData.realisasi_pinjaman, // optional string
              cicilan_perbulan: loanData.cicilan_perbulan, // optional number
              status_pengajuan: loanData.status_pengajuan, // optional enum
              validasi_pengajuan: loanData.validasi_pengajuan, // optional boolean
              catatan: loanData.catatan, // optional string
              catatan_spv: loanData.catatan_spv, // optional string
              catatan_marketing: loanData.catatan_marketing, // optional string
              is_banding: loanData.is_banding, // optional boolean
              alasan_banding: loanData.alasan_banding, // optional string
            },
            ...
            loan_guarantor: {
              ...
              penghasilan_penjamin:
                loanData.loan_guarantors.penghasilan_penjamin,
              no_hp_penjamin: loanData.loan_guarantors.no_hp_penjamin,

              persetujuan_penjamin:
                loanData.loan_guarantors.persetujuan_penjamin, // enum
            ...
            other_exist_loan: {
              ...
              validasi_pinjaman_lain:
                loanData.other_loans.validasi_pinjaman_lain, // optional boolean
